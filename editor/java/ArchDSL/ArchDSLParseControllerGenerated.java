...
public class ArchDSLParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("ArchDSL");
  ...
  { 
    ArchDSLParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ArchDSLParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ArchDSLParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ArchDSLParseControllerGenerated.class);
    }
  ...
  { 
    return ArchDSLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
