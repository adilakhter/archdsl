...
public class ArchDSLParseController extends DynamicParseController 
{ 
  ...
  { 
    try
    { 
      InputStream descriptorStream = ArchDSLParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ArchDSLParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ArchDSLParseController.class);
    }
